...
ENV JOBS=14 
RUN apt update && apt upgrade -y && apt install -y git python-dev python-pip python-libxml2 python-lxml libcurl4-openssl-dev libxml2-dev libxslt1-dev screen curl rpi-update node yarn gstreamer1.0-libav gstreamer1.0-plugins-base gstreamer1.0-plugins-bad gstreamer1.0-plugins-bad gstreamer1.0-plugins-ugly python3 python3-pip zlib1g-dev libv4l-dev npm && rm -rf /var/lib/apt/lists/*
