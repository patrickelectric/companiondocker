...
RUN apt update && apt upgrade -y && apt install -y git python-dev python-pip python-libxml2 python-lxml libcurl4-openssl-dev libssl-dev libxml2-dev libxslt1-dev screen curl rpi-update gstreamer1.0-libav gstreamer1.0-plugins-good python3 python3-pip zlib1g-dev libv4l-dev libraspberrypi-bin  && rm -rf /var/lib/apt/lists/* && /cleanup.sh
